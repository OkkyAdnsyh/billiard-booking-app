...
const Nav = ({type, href} : {type: 'Page' | 'Booking' | 'Waiting List', href?: Url}) => {
    const router = useRouter();
    if(type === 'Page') return (
        <>
            <NavElements.NavContainer>
                <NavElements.NavLinkGroup style='navLink_group_right'>
                    <NavElements.NavLink 
    ...
    if(type === 'Booking') return (
        <NavElements.NavContainer>
            <NavElements.NavLinkGroup style='navLink_group_spacing'>
